-- ยอดรวมใน orders.total_amount บางแถวเป็น 0 ทั้งที่ order_items.line_total ถูกต้อง (trigger เก่า/ค้าง)
-- เพิ่ม display_total_amount ใน view เพื่อให้รายการติดตามออเดอร์แสดงยอดสอดคล้องกับรายละเอียด
