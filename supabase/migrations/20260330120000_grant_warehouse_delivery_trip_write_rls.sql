-- ให้บทบาท warehouse สร้างและแก้ไขทริปจัดส่งได้ — สอดคล้องกับเมทริกซ์สิทธิ์ฟีเจอร์ (tab.delivery_trips)
-- เดิม RLS อนุญาตแค่ admin, manager, inspector จึงบล็อก INSERT แม้ UI จะเปิดสิทธิ์แล้ว

BEGIN;

-- ── delivery_trips (สร้างทริป / อัปเดต — ลบทริปยังเหมือนเดิม: เฉพาะ admin, manager) ──
...
-- ── delivery_trip_crews (ลบ crew ยังเฉพาะ admin, manager) ──
...
-- ── delivery_trip_item_changes (บันทึกประวัติแก้รายการในทริป) ──
