-- ========================================
-- Fix RLS Policy Always True Warnings (Safe Version)
...
-- This version uses DROP POLICY IF EXISTS to safely handle existing policies
-- ========================================
...
-- Drop existing policies (IF EXISTS prevents errors)
...
-- FROM pg_policies
-- WHERE tablename IN ('inventory_transactions', 'tickets', 'vehicle_alerts', 'audit_logs')
