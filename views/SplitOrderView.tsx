...
export const SplitOrderView: React.FC = () => {
    console.log('[SplitOrderView] Rendering...');
    ...
    const fetchOrders = useCallback(async () => {
        setLoading(true);
        console.log('[SplitOrderView] Fetching orders...');
        try {
            const data = await ordersService.getAwaitingDispatchOrders({
                branch: branchFilter === 'ALL' ? undefined : branchFilter
            });
            console.log('[SplitOrderView] Orders data received:', data);
            setOrders(Array.isArray(data) ? data : []);
        } catch (err: any) {
            console.error('[SplitOrderView] Fetch orders error:', err);
    ...
    return (
        <PageLayout title="แบ่งยอดส่ง (Dispatch Board)">
