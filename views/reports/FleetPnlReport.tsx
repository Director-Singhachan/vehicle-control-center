  ...
  const handleExportExcel = () => {
    ...
    try {
      ...
      const rowsSheet = data.rows.map((r) => ({
        ...
        profit_per_piece: r.profit_per_piece ?? '',
        ...
        [
          ...
          },
          {
            ...
            columns: [
              ...
              { key: 'cost_per_piece', label: 'ต้นทุนเต็ม/ชิ้น (บาท)', width: 18, format: (v: number | string) => (v === '' || v == null ? '-' : excelExport.formatCurrency(Number(v))) },
              {
                key: 'profit_per_piece',
                label: 'กำไรสุทธิ/ชิ้น (บาท)',
                width: 18,
                format: (v: number | string) => (v === '' || v == null ? '-' : excelExport.formatCurrency(Number(v))),
              },
