...
export const DeliveryReport: React.FC<DeliveryReportProps> = ({ startDate, endDate, isDark, onNavigateToStoreDetail }) => {
  ...
  const createSearchableText = useCallback((...texts: (string | null | undefined)[]): string => {
    return texts
      .filter(t => t)
