...
export const RoleFeatureAccessMatrixSection: React.FC<RoleFeatureAccessMatrixSectionProps> = ({
  ...
  return (
    <div className="space-y-8">
      ...
      {grouped.map((group) => (
        <div key={group.title}>
          <h3 className="text-xs font-black uppercase tracking-widest text-enterprise-600 dark:text-neon-blue mb-3">
            {group.title}
          </h3>
            ...
            {group.keys.map((key) => (
              ...
              >
                ...
                <select
                  ...
                  disabled={loading}
                  className="rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-charcoal-900 px-3 py-2 text-slate-900 dark:text-white text-sm min-w-[220px]"
                >
